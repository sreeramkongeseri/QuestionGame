...
function create () {
  ...
  this.physics.world.setBounds(0, -20, config.width + 20, config.height);
...
function createWords (phrase_text, phrase_BT) {
  ...
  let style = { fontFamily: 'Helvetica', color: '#000000', wordWrap: { width: 200, useAdvancedWrap: true }, fontSize: 15 }
