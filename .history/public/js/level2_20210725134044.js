...
function create ()
{
    scoreText = this.add.text(16, 16, 'score: 0', { font: '50px Helvetica', color: "#000000"});
...
function createWords(wordName, wordBucket) {
    ...
    word = self.add.text(0, 0, wordName, {fontFamily: 'Helvetica', color: "#000000", backgroundColor:'#ffa07a'}).setFontSize(40);
    word.baselineX = 10;
    word.baselineY = 50;
