...
function createWords (phrase_text, phrase_dok) {
  ...
  let x_coord = Phaser.Math.Between(text_cont_width/2, config.width - (text_cont_width/2));
  let y_coord = Phaser.Math.Between(text_cont_height/2, steps[4].y - (step_height/2) - (text_cont_height/2) - 1);
