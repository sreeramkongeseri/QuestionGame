...
function create () {
    ...
    scoreText = this.add.text(10, 0, 'score: 0', { font: '25px Helvetica', color: "#000000"});
...
function createWords(wordName, wordBucket) {
    ...
    var word = self.add.text(0, 0, wordName, {fontFamily: 'Helvetica', color: "#000000"}).setFontSize(35);
    
    var rect = self.add.rectangle(0, 0, 150, 50, 0xffffff);
    ...
    container.on('pointerover', function () {
        ...
        container.list[0].setFillStyle(0x6666ff);
