...
function create () {
    ...
    rect1 = self.add.rectangle(0, 0, rect1_width, rect_height, colors[3]);
    cont1 = self.add.container(config.width/2, config.height-100, [rect1]);
    cont1.setSize(rect1_width, rect_height);


    rect2 = self.add.rectangle(0, 0, rect2_width, rect_height, colors[3]);
    cont2 = self.add.container(config.width/2, config.height-100, [rect2]);
    cont2.setSize(rect2_width, rect_height);


    rect1 = self.add.rectangle(0, 0, rect1_width, rect_height, colors[3]);
    cont1 = self.add.container(config.width/2, config.height-100, [rect1]);
    cont1.setSize(rectWidth, rect_height);
