...
var num_destroyed = 0
var num_words = 1
var colors = [0xededed, 0xd1ebfe, 0x97d2fe, 0x4db2fc, 0x0894fb]
var channels = []
var rect_height = 150
var rect_conts = []
...
function create () {
  ...
  rect_widths = [1500, 1000, 800, 600, 400]
  y_up = 100
  for (let i = 0; i < 5; i++) {
    rect = self.add.rectangle(0, 0, rect_widths[i], rect_height, colors[4 - i])
