...
function create () {
    ...
    wordData = fetch(serverURL + '/api/level3').then(response => response.json()).then(quesData => {
        ...
        id = setInterval(() => { 
            ...
            quesName = Object.keys(quesData[cur])[0];
            wordBucket = Object.values(quesData[cur])[0];
