...
function create ()
{
    ...
    bins = this.physics.add.staticGroup({
        key: 'bin',
        repeat: 5,
        setXY: { x: 100, y: screen.height - 100, stepX: screen.width/6 }
    });
...
function createWords(wordName, wordBucket) {
    ...
    word = self.add.text(0, 0, wordName, {fontFamily: 'Helvetica', color: "#000000", backgroundColor:'#FFFFFF'}).setFontSize(40);
    word.baselineX = 10;
    word.baselineY = 50;
