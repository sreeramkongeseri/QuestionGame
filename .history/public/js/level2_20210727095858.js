...
function create () {
    ...
    bins.children.iterate(function (child) {
        ...
        label = self.add.text(child.x - 10, child.y - 100, names[i-1], {font: '25px Helvetica'});
...
function createWords(wordName, wordBucket) {
    ...
    style = {fontFamily: 'Helvetica', color: '#000000', wordWrap: {width: 300, useAdvancedWrap: true}, fontSize: 20};
