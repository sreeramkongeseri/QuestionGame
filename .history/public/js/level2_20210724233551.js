...
function create ()
{
    scoreText = this.add.text(16, 16, 'score: 0', { fontSize: '50px', color: "#000000"});
...
function createWords(wordName, wordBucket) {
    ...
    word = self.add.text(0, 0, wordName, {fontFamily: "Helvetica Neue", color: "#000000"}).setFontSize(20);
    container = self.add.container(Phaser.Math.Between(70, 900), -10, [ word ], {backgroundColor:'#ffa07a'});
